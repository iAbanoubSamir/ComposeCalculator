...
import com.compose.calculator.ui.theme.LightGray
import com.compose.calculator.ui.theme.Orange
...
fun Calculator(
    ...
    Box(modifier = modifier) {
        Column(
            ...
            Text(
                text = state.numberOne + (state.operation?.symbol ?: "") + state.numberTwo,
